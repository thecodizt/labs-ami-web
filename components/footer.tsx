...
const Footer = () => {
	...
	return (
		<FadeInSection
			className="p-8 bg-PURPLE rounded-t-lg shadow-sm w-full text-['Poppins'] text-white"
			isOnce
		>
			{(inView: boolean) => (
				<motion.ul
				...
				>
						...
						<div className="w-full flex gap-4 items-center">
							...
							>
								...
								<span className="text-xs">
									AMI Merchants Services Inc 13841 Harper Road
									Surrey, BC Canada V3R 5L5
								</span>
							</motion.li>
							<motion.li
								variants={item}
							...
							>
								...
								<span className="text-xs">
									American Merchants Inc 2219 W Olive Ave #106
							...
							>
								...
								<span className="text-xs">
									...
									Edmonton Mall The Bristol, Gurgaon, India
								</span>
							</motion.li>
						</div>
					...
					>
						<div className="flex gap-2 items-center">
							...
							<span className="text-xs">
								...
								registered ISO of Wells Fargo Bank, NA, Concord,
								CA, Fifth Third Bank, N.A. Cincinnati, OH, USA
								and Elavon, Inc. Georgia [a wholly owned
					...
					<div className="w-full flex justify-between items-center text-slate-400 text-xs pt-8">
						<span>
							Copyright ©️ American Merchants Inc. 2007 - 2024.
							All rights reserved. American Merchants Inc. is a
							registered trade mark. Any unauthorised use is
